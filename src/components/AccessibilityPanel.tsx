  ...
  return (
    <div className="w-full max-w-6xl space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Accessibility Checker</h2>
        <p className="text-slate-600 dark:text-slate-400 mt-2">
          Ensure your color palette meets WCAG accessibility standards
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900/70 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
        <h3 className="text-lg font-semibold mb-4">Color Blindness Simulation</h3>
        <div className="mb-4">
          <select
      ...
      <div className="bg-white dark:bg-slate-900/70 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
        ...
        <textarea
          ...
          className="w-full p-3 rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          rows={3}
